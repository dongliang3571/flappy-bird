...
function BackgroundObject() {
    ...
    this.draw = function() {
        ...
        context.drawImage(bgImage.backgroundImage, this.x, this.y, canvas_bg.width, canvas_bg.height);
        context.drawImage(bgImage.backgroundImage, -canvas_bg.width+this.x, this.y, canvas_bg.width, canvas_bg.height);
        this.x += this.speed;
